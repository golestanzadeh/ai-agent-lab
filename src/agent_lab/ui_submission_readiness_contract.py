...
BLOCKERS=("OFFICIAL_ERIC_PLAUSIBILITY_ENGINE_NOT_EXECUTED","REAL_PAYLOAD_NOT_AUTHORIZED","ARTICLE_1_CONTENT_RELEASE_NOT_APPROVED","ARTICLE_1_DESTINATION_TRANSMISSION_NOT_APPROVED","TRANSMITTER_NOT_IMPLEMENTED")
...
class SyntheticSubmissionReadiness:
    ...
    local_e10_status:str="LOCAL_MAPPING_XSD_AND_RULE_SUBSET_PASS"
    official_engine_status:str="NOT_EXECUTED"
    ...
    def __post_init__(self):
        ...
        if self.local_e10_status!="LOCAL_MAPPING_XSD_AND_RULE_SUBSET_PASS" or self.official_engine_status!="NOT_EXECUTED": raise UISubmissionReadinessError("technical readiness status cannot change")
