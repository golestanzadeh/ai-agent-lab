...
The local evaluator implements only those thirty-two reviewed conditions. It includes the existing wage and expense checks plus the bounded professional-association, work-equipment, home-office workroom, and training integrity rules; no broader semantics are inferred.
