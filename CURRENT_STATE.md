...
- Local FastAPI + Jinja/HTMX Persian UI through UI-16; critical safety, case lifecycle, document, Human Gate, decision, workflow, and recovery values have closed Persian labels while retaining technical codes.
...
- The focused documentation index now includes the current runtime recovery, E10 mapping/declaration/plausibility/readiness, and UI records through UI-16; a deterministic test prevents future silent index drift.
