...
- Local FastAPI + Jinja/HTMX Persian UI through UI-10; review, readiness, workflow, and support/recovery diagnostics reflect current local E10 completion and safely expose the absence of operational controls and receipts while keeping all external blockers explicit.
