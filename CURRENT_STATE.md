...
- Source-evidenced local plausibility profile version 7 evaluates thirty-two official Anlage N rules, including bounded single-item professional-association, work-equipment, home-office workroom, and training contracts.
...
After completing and pushing the profile-v7 training package, read live limits and select the next authorized, prerequisite-ready local synthetic package under the continuous-execution rules.
