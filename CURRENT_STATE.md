...
- Local FastAPI + Jinja/HTMX Persian UI through UI-17; closed Persian labels are joined by semantic document-table headers/caption, labelled decision expiry, and explicit left-to-right handling for technical identifiers.
...
- The focused documentation index now includes the current runtime recovery, E10 mapping/declaration/plausibility/readiness, and UI records through UI-17; a deterministic test prevents future silent index drift.
