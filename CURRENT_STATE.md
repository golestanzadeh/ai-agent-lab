...
- Source-evidenced local plausibility profile version 3 evaluates twelve official Anlage N presence rules, including gross-wage coverage for explicit spouse/life-partner church tax across both wage groups without inferring unsupported dependencies.
