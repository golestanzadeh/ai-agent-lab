...
@pytest.mark.parametrize("field,value",[("content_release_status","APPROVED"),("destination_transmission_status","APPROVED"),("local_e10_status","OFFICIAL_READY"),("official_engine_status","PASS"),("ready",True),("submission_enabled",True),("receipt_reference","sha256:"+"a"*64),("network_calls",("x",)),("blockers",())])
