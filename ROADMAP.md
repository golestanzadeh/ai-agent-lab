...
- O1-O5, P1 local synthetic packages 1-7, the four-role local runtime, and UI-1 through UI-18 are complete.
...
Status: **official 44.3.6.0 material retrieved; current local mapping/XSD/plausibility lineage integrated and externally blocked**
...
Status: **local synthetic prototype complete through UI-18 with Persian states, semantic accessibility, concise dynamic announcements, loopback launch, and browser hardening; real operations gated**
