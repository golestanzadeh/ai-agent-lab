...
- **Exact next action:** connect an eligible repair decision to a bounded remaining-stage continuation executor, preserving write-once attempt consumption, exact-prefix recovery, existing acceptance/budget/kill-switch controls, and all external capability denials.
