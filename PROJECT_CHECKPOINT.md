...
- **Exact next action:** after pushing combined other-expense aggregate boundary hardening, read live limits and select the next authorized, prerequisite-ready local synthetic package under the continuous-execution rules.
