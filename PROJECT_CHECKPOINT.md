...
- **Exact next action:** after pushing ferry-or-flight omission and identity hardening, read live limits and select the next authorized, prerequisite-ready local synthetic package under the continuous-execution rules.
