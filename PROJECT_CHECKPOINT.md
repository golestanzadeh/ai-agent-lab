...
- Exact autonomous next action: implement and verify registered UI package 2 (`ui_state_contract`) as an architecture-neutral, local, synthetic presentation-state boundary. It may not choose a framework, use real data, connect externally, authenticate, deploy, or enable submission.
