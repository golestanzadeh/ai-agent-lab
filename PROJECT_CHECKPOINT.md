...
- **Exact next action:** after pushing the mapping-v9/plausibility-v10 ferry-or-flight package, read live limits and select the next authorized, prerequisite-ready local synthetic package under the continuous-execution rules.
